...
from utils.dense_network_pruning import *
...
def initialize_nn_pruner():
    ...
    # args_nn.data = "/root/workspace/dataset/"
    # args_nn.model_path = "/root/workspace/home/zy/code/Imagenet/densenet121/model_best_no_module.pth.tar"
    # args_nn.sampled_imgs = "/root/workspace/home/zy/code/Imagenet/sampled_imgs1.pkl"
    
    args_nn.data = "/root/home/dataset/imagenet/"
    args_nn.model_path = "/root/home/zy/code/Imagenet/densenet121/model_best_no_module.pth.tar"
    args_nn.sampled_imgs = "sampled_images.pkl"   # "/root/home/zy/code/Imagenet/sampled_imgs1.pkl"
    
    args_nn.load_model = True
    args_nn.arch = 'densenet121'
    args_nn.dense_layer_nums = [6, 12, 24, 16]  # [3, 8, 36, 3]
    ...
    args_nn.pruner = DenseNetPruner  # ResNetPruner

    nn_pruner = DenseNetworkPruning(args_nn)  # NetworkPruning(args_nn)
    
    dec_dim = sum(args_nn.dense_layer_nums) # All prunable
...
if __name__ == '__main__':
    ...
    path_save = "results_prune_densenet121/"
    ...
    population = initialization(pop_size, args_ec)
